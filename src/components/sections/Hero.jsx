            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 xl:grid-cols-2 gap-14 xl:gap-20 items-center">
                    ...
                    <div className="w-full">
                        ...
                        <Badge className="inline-flex items-center gap-2 bg-white/80 backdrop-blur-xl border border-white/50 rounded-full px-4 sm:px-6 py-3 shadow-xl mb-6 sm:mb-8">
                            <FaCrown className="text-[#A36081] text-sm sm:text-lg" />
                            <span className="text-[#A36081] font-semibold text-xs sm:text-sm md:text-base">
                        ...
                        {/* BUTTONS */}
                        <div className="flex flex-col sm:flex-row gap-4 sm:gap-5 mb-10 lg:mb-14">
                    ...
                    ">
                        ...
                        ">
                            {HERO_STATS.slice(0, 6).map((item, i) => (
                                <div
                                    key={i}
                                    className={`stat-item animate-${i} text-center`}
                                >
                                    <div className="
                                        text-3xl
                                        sm:text-4xl
